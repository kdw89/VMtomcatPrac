...
function submitForm(mode){
	fm.action = "review_write_m.jsp?key=INSERT";
...
<table width=fixed class="table table-sm">
...
<tr>
<td><b>제목</b></td>
<td><input type=text id=title name=title maxlength=70></td>
</tr>
<tr>
<td><b>일자</b></td>
<%
...
<tr>
<td><b>내용</b></td>
<td><textarea style='width:fixed;' id=content name=content cols=70 row=600></textarea>
<script>
...
<tr>
<td width=80%></td>
<td><input type=button class="btn btn-warning btn-lg" value="취소" OnClick="location.href='review_list_m.jsp'"></td>

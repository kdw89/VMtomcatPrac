...
<div class='outline' >
<h3>예약하기</h3>
<form METHOD=POST name='fm' action="d_02_m_write.jsp" autocomplete='off'>
<table style="width:fixed" class="table table-sm">
<tr><td width=30%>성명</td>

<td width=70%><input type=text name="name" maxlength='20' style="font-size: large; width:fixed; height:40px;" onpaste="javascript:return false;" onkeyup="characterCheck()" onkeydown="characterCheck()" required></td>

</tr>
<tr><td>예약일자</td>

<td><input type=date id="date" name="resv_date" style="font-size: large; width:fixed; height:40px;" 
						min=<%=today_chk%> max=<%=after30days%> onchange="return checkDate();" value=<%=resv_date%> required></td>

</tr>
<tr><td>예약방</td>

<td><select name="room" id="room" style="font-size:large; text-align:center; width:fixed; height:40px;" required>
...
<td><input type=text name="addr" maxlength="40" style="font-size: large; width:fixed; height:40px;" required></td>

</tr>
<tr><td>전화번호</td>

<td><input type=text name="telnum" id="telnum" maxlength="13" style="font-size: large; width:fixed; height:40px;" required></td>

</tr>
<tr><td>입금자명</td>

<td><input type=text name="id_name" maxlength="13" style="font-size: large; width:fixed; height:40px;" required></td>

</tr>
<tr><td>남기실말</td>

<td><input type=text name="comment" maxlength="50" style="font-size: large; width:fixed; height:40px;" required></td>

</tr>
<tr style='text-align:center'>
<td colspan=2>
<input style="font-size: large; text-align:center; width:fixed; height:40px;" class="btn btn-primary btn-lg" type="submit" value="예약"></td>
</tr>
</table>
</div>
<script>
